...
export const CAR_GRIP_PERCENTAGE_ROAD = 0.6;
export const CAR_GRIP_PERCENTAGE_GROUND = 0.3;

export const DRAG_ROAD = 0.004;
export const DRAG_GROUND = 0.01;

export const TURN_SPEED_ROAD = 0.002;
export const TURN_SPEED_GROUND = 0.002;
